		...
		return (
			<View style={{ flex: 1, backgroundColor: Colors.white }}>
				...
				<View style={{ width: widthPerc(90), alignSelf: 'center' }}>
					...
					<TextInput tintColor={Colors.themeBlack} label="Email/Mobile" style={{ fontFamily: 'ProximaNova-Regular' }} value={userName} />
					<TextInput tintColor={Colors.themeBlack} label="Password" secureTextEntry value={password} />
